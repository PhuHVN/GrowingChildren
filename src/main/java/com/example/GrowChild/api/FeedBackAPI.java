...
public class FeedBackAPI {
    ...
    public ResponseEntity createFeedBack(@Valid @RequestBody FeedBackRequest feedBackRequest,
                                         String doctorId, String parentId){

        FeedBack feedBack = feedBackService.createFeedBack(feedBackRequest, doctorId, parentId);
        return new ResponseEntity<>(feedBack, HttpStatus.CREATED);
    }

    @GetMapping("getALl")
    public List<FeedBackDTO> getAllFeedBack(){return feedBackService.getAll();}
